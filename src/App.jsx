...
const URLS = {
  portfolio: "https://github.com/jtemblador/Portfolio",
  resume: "hhttps://github.com/jtemblador/Portfolio/blob/main/JoseTrinidadTemblador_Resume.pdf",
  linkedin: "https://linkedin.com/in/josetemblador",
  github: "https://github.com/jtemblador/",
  blackjack: "https://github.com/jtemblador/Portfolio/tree/main/Projects/Blackjack"
}
    ...
    <div className={`fixed w-[735px] h-screen transition-colors duration-300 ${
      ...
      <div className="max-w-[1600px] mx-auto px-32 h-full flex flex-col justify-between">
        ...
        <div className="flex space-x-4 mb-8">
          <a href={URLS.github} className="text-gray-400 transition-colors duration-200 ease-in-out hover:text-white">
          ...
          <a href={URLS.linkedin} className="text-gray-400 transition-colors duration-200 ease-in-out hover:text-white">
                ...
                <div className="flex space-x-4 ">
                  ...
                  <div className="relative group">
                    ...
                    <div className={`absolute hidden group-hover:block left-0 mt-2 p-2 rounded-lg shadow-lg z-10 ${
                      ...
                      <img src="/assets/blackjack1.gif" alt="Blackjack Demo" className="max-w-[300px] rounded" />
                    </div>
                  </div>
                </div>
