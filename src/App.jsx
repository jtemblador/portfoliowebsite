            ...
            <h2 className={`text-3xl font-bold mb-6 ${
              ...
              <ul className="grid grid-cols-3 gap-2 ml-4">
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> Python
                </li>
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> C++
                </li>
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> Java
                </li>
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> JavaScript (ES6+)
                </li>
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> React.js
                </li>
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> Node.js
                </li>
                <li className="flex items-center">
                  <span className={`mr-2 text-sm ${isDark ? 'text-green-400' : 'text-[#e10000]'}`}>▹</span> Tailwind CSS
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className={`p-6 rounded-lg transition-colors ${
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className={`text-sm rounded px-3 py-1 ${
                    isDark ? 'text-white bg-green-800' : 'text-[#ffe6cd] bg-[#e10000]'
                  }`}>Documentation</span>
                  <span className={`text-sm rounded px-3 py-1 ${
                    isDark ? 'text-white bg-green-800' : 'text-[#ffe6cd] bg-[#e10000]'
