      ...
      <div className="max-w-[950px] mx-auto px-32">
        <div className="pt-28 space-y-16">
          ...
          <section id="experience" className="max-w-3xl">
            <h2 className="text-3xl text-white font-bold mb-6">Experience</h2>
            <div className="space-y-8">
              <div className="bg-[#112240] p-6 rounded-lg hover:bg-[#1a2f70] transition-colors">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Documentation</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Project Management</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Analysis</span>
                </div>
              </div>
              ...
              <div className="bg-[#112240] p-6 rounded-lg hover:bg-[#1a2f70] transition-colors">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Leadership</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Music</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Team Management</span>
                </div>
              </div>
              ...
              <div className="bg-[#112240] p-6 rounded-lg hover:bg-[#1a2f70] transition-colors">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Healthcare</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Patient Care</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Documentation</span>
                </div>
              </div>
            </div>
          ...
          <section id="projects" className="max-w-3xl">
            <h2 className="text-3xl text-white font-bold mb-6">Some Things I've Built</h2>
            <div className="grid gap-6">
              <div className="bg-[#112240] p-6 rounded-lg hover:bg-[#1a2f70] transition-colors">
                <h3 className="text-xl text-white font-bold mb-2">Blackjack Game</h3>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">C++</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">OOP</span>
                  <span className="text-sm text-white bg-green-800 rounded px-3 py-1">Data Structures</span>
                </div>
              </div>
            </div>
